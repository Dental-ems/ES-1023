...
#define LIB_REMOTE_PZ_TRAME_LEN_RESP   LIB_REMOTE_AF_TRAME_LEN_RESP
#define LIB_REMOTE_PZ_TRAME_LEN_REQ    LIB_REMOTE_AF_TRAME_LEN_REQ
#define LIB_REMOTE_PZ_TRAME_EOF        LIB_REMOTE_AF_TRAME_EOF
...
{
    LIB_REMOTE_PZ_REQ_UNDEF   = LIB_REMOTE_AF_REQ_UNDEF,
    LIB_REMOTE_PZ_REQ_HOLDER  = LIB_REMOTE_AF_REQ_HOLDER,
    LIB_REMOTE_PZ_REQ_ENCODER = LIB_REMOTE_AF_REQ_ENCODER,
    LIB_REMOTE_PZ_REQ_RFID    = LIB_REMOTE_AF_REQ_RFID,
    LIB_REMOTE_PZ_REQ_VOLT    = LIB_REMOTE_AF_REQ_VOLT,
    LIB_REMOTE_PZ_REQ_DETECT  = LIB_REMOTE_AF_REQ_DETECT,
    LIB_REMOTE_PZ_REQ_LED_ON  = LIB_REMOTE_AF_REQ_LED_ON,
    LIB_REMOTE_PZ_REQ_LED_OFF = LIB_REMOTE_AF_REQ_LED_OFF,
    LIB_REMOTE_PZ_REQ_MAX     = LIB_REMOTE_AF_REQ_MAX,
};
